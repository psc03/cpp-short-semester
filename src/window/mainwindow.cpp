...
void MainWindow::init() {
  ...
  connect(initialpage, &InitialPage::switchToAboutPage, this,
          &MainWindow::do_showAboutPage);
  connect(initialpage, &InitialPage::switchToGamePage, this,
          &MainWindow::do_showGamePage);
  connect(aboutPage, &AboutPage::switchToInitialPage, this,
          &MainWindow::do_showInitialPage);
  connect(gamePage, &GamePage::switchToInitialPage, this,
          &MainWindow::do_showInitialPage);
}

GamePage* MainWindow::getGamePage() { return gamePage; }
