...
void InitialPage::Init() {
  ...
  // 显示文本 双人模式
  DoublePlay_Button->setText(QCoreApplication::translate(
      "InitialPage", "\345\217\214\344\272\272\346\250\241\345\274\217",
      nullptr));

  About_Button->setObjectName("About_Button");
  About_Button->setGeometry(QRect(170, 400, 141, 51));
  // 显示文本 双人模式
  About_Button->setText(QCoreApplication::translate(
      "InitialPage", "\345\205\263\344\272\216", nullptr));

  Exit_Button->setObjectName("Exit_Button");
  Exit_Button->setGeometry(QRect(170, 470, 141, 51));
  // 显示文本 双人模式
  Exit_Button->setText(QCoreApplication::translate(
      "InitialPage", "\351\200\200\345\207\272\346\270\270\346\210\217",
      nullptr));

  QMetaObject::connectSlotsByName(this);
}

void InitialPage::on_DoublePlay_Button_clicked() { emit switchToGamePage(); }

void InitialPage::on_About_Button_clicked() { emit switchToAboutPage(); }
